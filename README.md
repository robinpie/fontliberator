...
This in particular is an unexplored case, and I cannot be certain, but I believe that the outputted `.otf` is probably uncopyrightable in the US. The typeface design itself is uncopyrightable (obviously). The font software generated by this program is, I believe, also uncopyrightable for at least one of these reasons:
...
* fonttools
* fontconfig
* a system font renderer that imagemagick likes (FreeType, Core Text, and DirectWrite (if you can get this going in a Windows environment) should all be fine)
